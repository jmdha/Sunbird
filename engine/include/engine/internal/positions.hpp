#ifndef ENGINE_POSITIONS
#define ENGINE_POSITIONS
...
namespace Positions {
static inline std::vector<std::string> positions{
    ...
    "2r2r2/p2b1pk1/3Pp1p1/q3P2p/2p4P/2N1R3/P1BQ1PP1/6K1 b - - 1 26",
    "1r3rk1/ppq2ppb/1np1p2p/8/P2PnP2/1Q2PNN1/1P3PBP/R3R1K1 b - - 2 18",
    "4q1k1/1QR3p1/3rNp1p/1p3n2/3P1P2/4P1P1/5P2/6K1 b - - 0 35",
    "r2r2k1/1p3ppp/p1p1p3/3nb3/1P1P4/2Pb2PP/1P1B1PB1/R3R1K1 w - - 0 24",
    "2rqr1k1/pp2ppbp/2n3p1/3P1b2/8/B3P1P1/P3NPBP/2RQ1RK1 b - - 0 14",
    "1q2r1k1/3bppbp/8/1pRPn1pN/p2BP3/P5PP/1Q3PB1/6K1 b - - 1 25",
    "rnbqk2r/pp2ppbp/6p1/2p5/3PP3/2P2N1P/P4PP1/R1BQKB1R b KQkq - 0 8",
    "r2q1rk1/1p3pbp/2p2np1/1P1p1b2/3P4/2N1PN2/4BPPP/R2Q1RK1 w - - 1 16",
    "q5k1/5pbp/2p3p1/2Np1b2/3P2B1/4P3/5PPP/1r1Q1RK1 w - - 6 23",
    "r4rk1/1p3p1p/pb3Q2/1q6/1P6/P5P1/5P1P/2R2RK1 w - - 1 22",
    "r3r1k1/p3qp1p/2p1n1p1/3pQ3/1B1Pn1P1/P3PN1P/1P3PK1/R3R3 b - - 6 24",
    "8/6k1/3rn3/p2r1p2/2Q1PP1p/P1P2K1P/5N2/8 b - - 0 44",
    "r2q1rk1/p2nppbp/1p4p1/n2NN3/2PP4/6P1/PB2QP1P/R4RK1 b - - 4 16",
    "1r6/4pk2/p1r1bpp1/7p/8/2B1R2P/PP3PPK/4R3 w - - 2 25",
    "2r5/p4kp1/1p1bpn1p/n7/2qp1B2/5QP1/PP2PPBP/5RK1 w - - 6 24",
    "6k1/p3pp1p/6p1/2prPb2/PrNp4/1P6/2P2PPP/2RR2K1 w - - 4 26",
    "8/p4pkp/2R5/P3Pp2/2p2P2/8/2r4P/6K1 b - - 1 38",
    "3r2k1/p4p1p/3q2p1/5bb1/4BP2/1P1pR1P1/P2Q3P/3R2K1 b - - 0 29",
    "8/p4p1p/6p1/5kP1/5P2/1Pr1R2P/P4K2/8 b - - 2 47",
    "1r1q1rk1/p3ppbp/2ppb1p1/2n5/P3P3/1PNB4/1BPQ1PPP/R3R1K1 w - - 5 15",
    "6k1/p4p1p/4p3/2prPb2/P4P2/3PN3/1r3K1P/2RR4 w - - 2 32",
    "8/7p/p5p1/2bk1p2/4p3/2B1P1P1/PPK2P1P/8 b - - 2 26",
    "r2r2k1/pp2qp2/6p1/2p2b1p/2p1n3/1P1BPN1P/PQ3PP1/2RR2K1 w - - 0 20",
    "2r1r1k1/ppq2ppp/8/4Nn1b/3P4/1R4PP/P1PQ1RBK/8 b - - 2 23"};

static inline std::vector<std::string> GetPositions(int count) {
    std::vector<std::string> pos;
    std::sample(positions.begin(), positions.end(), std::back_inserter(pos), count,
