...
void Board::MakeMove(const Move &move) noexcept {
    ...
    case MoveType::NPromotion: newPType = PieceType::Knight; goto QUIET_PROMOTION;
    case MoveType::BPromotion: newPType = PieceType::Bishop; goto QUIET_PROMOTION;
    case MoveType::RPromotion: newPType = PieceType::Rook; goto QUIET_PROMOTION;
    case MoveType::QPromotion: newPType = PieceType::Queen; goto QUIET_PROMOTION;
    ...
    QUIET_PROMOTION:
        ...
        break;
    case MoveType::NPromotionCapture: newPType = PieceType::Knight; goto CAPTURE_PROMOTION;
    case MoveType::BPromotionCapture: newPType = PieceType::Bishop; goto CAPTURE_PROMOTION;
    case MoveType::RPromotionCapture: newPType = PieceType::Rook; goto CAPTURE_PROMOTION;
    case MoveType::QPromotionCapture: newPType = PieceType::Queen; goto CAPTURE_PROMOTION;
