...
constexpr std::array<int, PIECECOUNT> pieceValues{(int)PieceValue::Pawn, (int)PieceValue::Knight,
                                                  (int)PieceValue::Bishop, (int)PieceValue::Rook,
                                                  (int)PieceValue::Queen};
...
constexpr U64 KingMoves[64] = {770LLU,
                               1797LLU,
                               3594LLU,
                               7188LLU,
                               14376LLU,
                               ...
                               3951704919769088LLU,
                               7903409839538176LLU,
                               15806819679076352LLU,
                               31613639358152704LLU,
                               63227278716305408LLU,
                               54114388906344448LLU,
                               216739030602088448LLU,
                               505818229730443264LLU,
                               1011636459460886528LLU,
                               2023272918921773056LLU,
                               4046545837843546112LLU,
                               8093091675687092224LLU,
                               16186183351374184448LLU,
                               13853283560024178688LLU,
                               144959613005987840LLU,
                               362258295026614272LLU,
                               724516590053228544LLU,
                               1449033180106457088LLU,
                               2898066360212914176LLU,
                               5796132720425828352LLU,
                               11592265440851656704LLU,
                               4665729213955833856LLU};
constexpr U64 KnightMoves[64] = {132096LLU,
                                 329728LLU,
                                 659712LLU,
                                 1319424LLU,
                                 2638848LLU,
                                 ...
                                 2833441750646784LLU,
                                 5666883501293568LLU,
                                 11333767002587136LLU,
                                 22667534005174272LLU,
                                 45053588738670592LLU,
                                 18049583422636032LLU,
                                 145241105196122112LLU,
                                 362539804446949376LLU,
                                 725361088165576704LLU,
                                 1450722176331153408LLU,
                                 2901444352662306816LLU,
                                 5802888705324613632LLU,
                                 11533718717099671552LLU,
                                 4620693356194824192LLU,
                                 288234782788157440LLU,
                                 576469569871282176LLU,
                                 1224997833292120064LLU,
                                 2449995666584240128LLU,
                                 4899991333168480256LLU,
                                 9799982666336960512LLU,
                                 1152939783987658752LLU,
                                 2305878468463689728LLU,
                                 1128098930098176LLU,
                                 2257297371824128LLU,
                                 4796069720358912LLU,
                                 9592139440717824LLU,
                                 19184278881435648LLU,
                                 38368557762871296LLU,
                                 4679521487814656LLU,
                                 9077567998918656LLU};
...
constexpr int PosValuePawn[64] = {0,  0,  0,  0,  0,  0,   0,  0,  5,  10, 10, -20, -20, 10, 10, 5,
                                  5,  -5, 10, 0,  0,  -10, -5, 5,  0,  0,  0,  20,  20,  0,  0,  0,
                                  5,  5,  10, 25, 25, 10,  5,  5,  10, 10, 20, 30,  30,  20, 10, 10,
                                  50, 50, 50, 50, 50, 50,  50, 50, 0,  0,  0,  0,   0,   0,  0,  0};

constexpr int PosValueKnight[64] = {-50, -40, -30, -30, -30, -30, -40, -50, -40, -20, 0,   0,   0,
                                    0,   -20, -40, -30, 0,   10,  15,  15,  10,  0,   -30, -30, 5,
                                    15,  20,  20,  15,  5,   -30, -30, 0,   15,  20,  20,  15,  0,
                                    -30, -30, 5,   10,  15,  15,  10,  5,   -30, -40, -20, 0,   5,
                                    5,   0,   -20, -40, -50, -40, -30, -30, -30, -30, -40, -50};

constexpr int PosValueBishop[64] = {-20, -10, -10, -10, -10, -10, -10, -20, -10, 5,   0,   0,   0,
...
constexpr int PosValueRook[64] = {0,  0,  0,  5,  5,  0,  0,  0 - 5, 0, 0, 0, 0, 0, 0, -5, -5,
                                  0,  0,  0,  0,  0,  0,  -5, -5,    0, 0, 0, 0, 0, 0, -5, -5,
                                  0,  0,  0,  0,  0,  0,  -5, -5,    0, 0, 0, 0, 0, 0, -5, 5,
                                  10, 10, 10, 10, 10, 10, 5,  0,     0, 0, 0, 0, 0, 0, 0};

constexpr int PosValueQueen[64] = {-20, -10, -10, -5,  -5,  -10, -10, -20 - 10, 0,   5,   0,  0, 0,
